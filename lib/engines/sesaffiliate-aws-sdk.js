...
/*
 * 3HGroup 11/2014 - SDKSESAFFILIATE - copy of SDKSES transport
 *
...
// Expose to the world
module.exports = SDKSESAFFILIATETransport;
 ...
 */
function SDKSESAFFILIATETransport(options){
 ...
 */
SDKSESAFFILIATETransport.prototype.sendMail = function(emailMessage, callback) {
...
SDKSESAFFILIATETransport.prototype.handleMessage = function(msgObject, email, callback) {
...
SDKSESAFFILIATETransport.prototype.responseHandler = function(response, callback) {
...
SDKSESAFFILIATETransport.prototype.generateMessage = function(emailMessage, callback) {
    var email = "";
